program main
!This is the code to read Jan's polar coordinate file and generate 23050
!configuraitons. Notice here I did not just generate those configurations, I
!gave them some perturnbed values.

!Usage:
!Put the code with 'Energies_4000.txt'. After compiling just execute
!without argument.
...
double precision::r1,r2,r3,r4,r5,num,rdis
double precision::r1c,r2c,r3c,r4c,r5c,theta1c
double precision::theta2c,alpha1c,alpha2c,alpha3c,beta1c,beta2c,tauc
double precision::rCO,rHO,AOCO,AHOH
double precision::rnear,rmid,rfar
...
!initio lize, eq are ab initio eq
...
alpha2= 90! theta  [0,360],         eq=90
beta1= 90 !beta  (0,90],          eq=90
beta2= 180 ! alpha   [0,180],         eq=180
...
open(11,status='unknown',file='Jans-configs.xyz')
...
do n=1,23050
read(12,*) j,intco(5),intco(9),intco(10),intco(11),intco(12)

CALL RANDOM_NUMBER(num)
intco(1)= r1-0.005+0.01*num
CALL RANDOM_NUMBER(num)
intco(2)= r2-0.005+0.01*num
write(*,*) intco(2)
CALL RANDOM_NUMBER(num)
intco(3)= r3-0.005+0.01*num
CALL RANDOM_NUMBER(num)
intco(4)= r4-0.005+0.01*num
CALL RANDOM_NUMBER(num)
intco(6)= theta1-3.0+6.0*num
CALL RANDOM_NUMBER(num)
intco(7)= theta2-3.0+6.0*num
write(*,*) intco(7)
CALL RANDOM_NUMBER(num)
...
!This subroutine belongs to Jan.
